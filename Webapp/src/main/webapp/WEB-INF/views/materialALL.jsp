...
<link rel="stylesheet" type="text/css" href="resources/css/material.css" /> 
 <script type="text/javascript" src="resources/js/material.js"></script>
<title>materialALL</title>
</head>
<body>
	<div class="container">
		...
		<form name="registration" class="registartion-form"
			...
			<table>
				...
				<tr>
					...
					<td><textarea name="about" id="about"
							placeholder="Write about yourself..."></textarea></td>
				</tr>
				<tr>
